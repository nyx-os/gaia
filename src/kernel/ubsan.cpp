...
static void tu_print_location(const char *message,
  ...
  Gaia::error("tinyubsan: {} at file {}, line {}, column {}", message, loc.file,
              loc.line, loc.column);
}
...
void __ubsan_handle_shift_out_of_bounds(
  ...
  Gaia::log("left type is {}, right is {}", data->left_type->name,
...
void __ubsan_handle_nonnull_return_v1(struct tu_nonnull_return_data *data) {
  tu_print_location("non-null return is null", data->location);
}
...
void __ubsan_handle_missing_return(struct tu_unreachable_data *data) {
